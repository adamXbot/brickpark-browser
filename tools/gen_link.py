...
def main():
    ...
    # `portable/tools/addr_sweep.py` is the gate; this is the notice.
    ...
    if addr_collisions:
        globals_c += [
            ...
            ' * ruling for each row is portable/tests/addr_collisions.txt.',
            ' */']
        ...
        globals_c += [
            ...
            f'addresses -- see the block above and portable/tests/addr_collisions.txt"',
            '#endif',
            '']
    ...
    if addr_collisions:
        manifest += [
            ...
            '`portable/tests/addr_collisions.txt`, gated by the `addr_sweep`',
            'ctest.', '',
        ...
        print(f'gen_link: WARNING {len(addr_collisions)} name(s) declared at '
              ...
              f'portable/tests/addr_collisions.txt.')
    if interiors:
