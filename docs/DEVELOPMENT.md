# BrickPark browser: development notes

This is the long half of the README: how the tree is built and laid out, the
tests and CI, and then the log of the port, lane by lane, in the order the
work happened. [README.md](../README.md) is the short version: what you need,
and how to build and play.

Lane notes cited below as `docs/lanes/scope-*.md` or `docs/SCOPE_*.md` were
working notes and are archived out of the tree. They remain in the history of
[brickpark-decomp](https://github.com/adamXbot/brickpark-decomp), and its
[docs/ARCHIVE.md](https://github.com/adamXbot/brickpark-decomp/blob/main/docs/ARCHIVE.md)
says how to read one. `README.md` in the text below means this file.
